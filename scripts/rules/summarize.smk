rule store_timings:
    input:
        ...
        files=expand(
            ...
            + [f"{param1}={param2}" for param1 in config["PARAMS"]["MODE"] or config["DEFAULT_PARAMS"]["MODE"] for param2 in config["PARAMS"]["T_MAX"] or config["DEFAULT_PARAMS"]["T_MAX"]]
    ...
    log: "log/store_timings.log",
    conda: "../envs/r_basic_env.yaml"
    shell:
        """
